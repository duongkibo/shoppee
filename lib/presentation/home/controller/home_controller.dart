...
import '../../../data/grocery/data_source/local/product_data_source.dart';
import '../../../data/grocery/model/response/category_response/category_reponse_model.dart';
import '../../../data/grocery/model/response/product_reponse/item_grocery.dart';
import '../../../data/grocery/repositories/grocery_repo.dart';
import '../../../data/grocery/repositories/user_repo.dart';
import '../../../domain/grocery/use_cases/login_user_grocery_usecase.dart';
import '../../../domain/login/use_cases/get_data_product_use_case.dart';
import '../../../domain/login/use_cases/get_list_category.dart';
import '../../../domain/login/use_cases/login_grocery_usecase.dart';
...
class HomeController extends GetxController {
  ...
  void selectListProductByCategory(String idCategoryID) {
 ...
 Future<void> getTokenUser() async{
  ...
  Future<void> getToken() async {
    final data = await _loginGrocery.loginGrocery('admin', 'admin');
